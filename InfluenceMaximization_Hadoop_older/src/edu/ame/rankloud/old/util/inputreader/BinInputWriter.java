...
public class BinInputWriter {

	public static void main(String[] args) throws IOException {
		String inDir = "adjList";
		String outDir = "simulation/input/graph";
		
		JobConf conf = new JobConf(BinInputWriter.class);
		...
		conf.setMapperClass(BinInputWriterMapper.class);
